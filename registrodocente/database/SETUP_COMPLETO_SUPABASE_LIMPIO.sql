-- ============================================================================
-- SETUP COMPLETO DE BASE DE DATOS SUPABASE (VERSIÓN LIMPIA)
-- Registro Docente - Todas las tablas necesarias
-- ============================================================================
-- IMPORTANTE: Este script elimina políticas duplicadas antes de crearlas
-- ============================================================================
...
-- ============================================================================
-- 4. TABLA: datos_generales_estudiantes
-- ============================================================================
...
BEGIN
    ...
    DROP POLICY IF EXISTS "Los usuarios pueden subir sus propias fotos de perfil" ON storage.objects;
    DROP POLICY IF EXISTS "Los usuarios pueden actualizar sus propias fotos de perfil" ON storage.objects;
    DROP POLICY IF EXISTS "Todos pueden ver las fotos de perfil" ON storage.objects;
    DROP POLICY IF EXISTS "Los usuarios pueden eliminar sus propias fotos de perfil" ON storage.objects;
EXCEPTION
